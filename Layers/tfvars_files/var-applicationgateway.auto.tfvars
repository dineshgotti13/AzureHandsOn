...
ado_subscription_id      = "[__subscriptionID__]"

application_gateways = {
  "appgw1" = {
    name                       = "jstartvm01082021lv20gw"
    zones                      = ["1", "2", "3"]
    enable_http2               = true
    ...
    frontend_ip_configurations = [
      {
        name                      = "appgateway-feip01"
        subnet_name               = "applicationgateway"
        vnet_name                 = null #"jstartvmsecond"
        networking_resource_group = "[__networking_resource_group__]"
        static_ip                 = null
        enable_public_ip          = true
        domain_name_label         = "stratum01"
      }
    ]
    ...
    http_listeners = [
      {
        name                           = "https-tc-lstn"
        frontend_ip_configuration_name = "appgateway-feip01"
